...
reset.classList.add('tool-button-other');
...
resize.classList.add('tool-button-other');
...
gradient.classList.add('tool-button');
...
black.classList.add('tool-button');
...
color.classList.add('tool-button');
...
const allRoomBtns = document.querySelectorAll('.tool-button')

allRoomBtns.forEach(function(item) {
    item.addEventListener("click", function(e) {
      allRoomBtns.forEach(function(element) {
        element.classList.remove('tool-button-active');
        e.target.classList.add('tool-button-active');
      });
    })
  });
